-- Read-only reporting directory for ZeControl owners and administrators.
-- This avoids exposing broader shared-profile fields or requiring a fragile
-- client-side join across public and zecontrol.

create or replace function zecontrol.list_report_profiles(
